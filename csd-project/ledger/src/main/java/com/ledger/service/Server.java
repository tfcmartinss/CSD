...
public class Server {
    ...
    public void init() throws Exception {
        ...
        this.privateKey = (PrivateKey) keyStore.getKey(this.serverKeystoreAlias, this.serverKeystorePassword.toCharArray());
        ...
        this.publicKey = keyStore.getCertificate(this.clientKeystoreAlias).getPublicKey();
    }
